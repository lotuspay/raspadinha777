                ...
                <div class="flex gap-3 items-center">
                    ...
                    <div class="relative group" x-data="{ open: false }" @mouseover="open = true" @mouseleave="open = false">
                        ...
                        <div x-show="open" 
                             ...
                             class="absolute bg-gray-700 mt-1 rounded shadow-md w-40 right-0 z-50">
                            ...
                            <a href="logout.php" class="block px-4 py-2 hover:bg-gray-600 transition-colors text-red-400 hover:text-red-300">Sair</a>
                        </div>
                    </div>
                </div>
            <?php else: ?>
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="raspadinha-grid">
                    ...
                    <div class="raspadinha-card">
                        ...
                        <?php if ($usuarioLogado): ?>
                            <a href="jogo/?valor=<?= $valor ?>&nome=<?= urlencode($tipo['nome']) ?>" class="play-button">
