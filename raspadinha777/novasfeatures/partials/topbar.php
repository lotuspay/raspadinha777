        ...
        <nav class="topbar-custom d-flex justify-content-between" id="topbar-custom">    
            ...
            <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">                        
                ...
                <li class="mx-3 welcome-text">
                    ...
                    <h6 class="mb-0 fw-normal text-white text-truncate fs-14" style="margin-top: 4px;">Gerenciando A Plataforma: <?=$dataconfig['nome'];?></h6>
                </li>                   
            </ul>
            <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                <li class="hide-phone app-search">
                    <form role="search" action="#" method="get">
                        <input type="search" name="search" class="form-control top-search mb-0" placeholder="Procurar usuário...">
                ...
                <li class="dropdown">
                    ...
                    <img src="assets/images/flags/br.png" alt="" class="thumb-sm rounded-circle">
                    </a>
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="#"><img src="assets/images/flags/br.png" alt="" height="15" class="me-2">Português</a>
                    </div>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="All" role="tabpanel" aria-labelledby="all-tab" tabindex="0">
                                    ...
                                    <a href="#" class="dropdown-item py-3">
                                        <small class="float-end text-white ps-2">2 min ago</small>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-2 text-truncate">
                                                ...
                                                <small class="text-white mb-0">Dummy text of the printing and industry.</small>
                                            </div><!--end media-body-->
                                        </div><!--end media-->
                                    </a><!--end-item-->
                                    <!-- item-->
                                    ...
                                    <a href="#" class="dropdown-item py-3">
                                        <small class="float-end text-white ps-2">10 min ago</small>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 bg-primary-subtle text-primary thumb-md rounded-circle">
                                            ...
                                            <div class="flex-grow-1 ms-2 text-truncate">
                                                ...
                                                <small class="text-white mb-0">It is a long established fact that a reader.</small>
                                            </div><!--end media-body-->
                                        </div><!--end media-->
                                    </a><!--end-item-->
                                    <!-- item-->
                                    ...
                                    <a href="#" class="dropdown-item py-3">
                                        <small class="float-end text-white ps-2">40 min ago</small>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 bg-primary-subtle text-primary thumb-md rounded-circle">                                                    
                                            ...
                                            <div class="flex-grow-1 ms-2 text-truncate">
                                                ...
                                                <small class="text-white mb-0">Dummy text of the printing.</small>
                                            </div><!--end media-body-->
                                        </div><!--end media-->
                                    </a><!--end-item-->
                                    <!-- item-->
                                    <a href="#" class="dropdown-item py-3">
                                        <small class="float-end text-white ps-2">1 hr ago</small>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 bg-primary-subtle text-primary thumb-md rounded-circle">
                                    ...
                                    <!-- item-->
                                    <a href="#" class="dropdown-item py-3">
                                        <small class="float-end text-white ps-2">2 hrs ago</small>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 bg-primary-subtle text-primary thumb-md rounded-circle">
                    ...
                    <div class="dropdown-menu dropdown-menu-end py-0">
                        <div class="d-flex align-items-center dropdown-item py-2 bg-secondary-subtle">
                            ...
                            <div class="flex-grow-1 ms-2 text-truncate align-self-center">
                                ...
                                <small class="text-white mb-0">Plataforma: <?=$dataconfig['nome'];?></small>
                            </div><!--end media-body-->
                        </div>
                        <div class="dropdown-divider mt-0"></div>
                        <small class="text-white px-2 pb-1 d-block">Gerenciar Usuarios</small>
                        <a class="dropdown-item" href="administradores"><i class="las la-user fs-18 me-1 align-text-bottom"></i> Operadores</a>
                        
                        <small class="text-white px-2 py-1 d-block">Configurações</small>                        
                       
                        <a class="dropdown-item" href="#"><i class="las la-lock fs-18 me-1 align-text-bottom"></i> 2FA</a>                       
